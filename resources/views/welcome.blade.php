        ...
        <section id="slider">
            <div id="carousel-example-generic" class="carousel slide carousel-fade" data-ride="carousel" data-interval="3000">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <img src="{{asset('assets/user-fontend/img/img1.jpg')}}" alt="...">
                    ...
                    <div class="item">
                        <div class="slider_overlay">
                            <img src="{{asset('assets/user-fontend/img/img2.jpg')}}" alt="...">
                            <div class="carousel-caption">
                                <div class="slider_text">
                                    <h3>Protect</h3>
                                    <h2>nature the environment</h2>
                    ...
                    <div class="item">
                        <div class="slider_overlay">
                            <img src="{{asset('assets/user-fontend/img/img3.jpg')}}" alt="...">
                            <div class="carousel-caption">
                                <div class="slider_text">
                                    <h3>Protect</h3>
                                    <h2>nature the environment</h2>
           ...
           <form action="{{route('subscriber.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
              ...
              <div class="input-group">
                <input type="text" name="email" class=" form-control" placeholder="Your-email@website.com">
                <button type="submit" value="submit"><i class="vol_cust_btn">Subscribe</i></button>
              </div>
            </form><br>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-6 zero_mp">
                                <div class="event_item">
                                    <div class="event_img">
                                        <img src="{{asset('assets/user-fontend/img/tree_cut_1.jpg')}}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 zero_mp">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 zero_mp">
                                <div class="event_item">
                                    <div class="event_img">
                                        <img src="{{asset('assets/user-fontend/img/tree_cut_2.jpg')}}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="event_news">
                            <div class="event_single_item fix">
                                <div class="event_news_img floatleft">
                                    <img src="{{asset('assets/user-fontend/img/tree_cut_3.jpg')}}" alt="">
                                </div>
                        ...
                        <div class="event_news">
                            <div class="event_single_item fix">
                                <div class="event_news_img floatleft">
                                    <img src="{{asset('assets/user-fontend/img/tree_cut_4.jpg')}}" alt="">
                                </div>
                                <div class="event_news_text">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="blog_news">
                            <div class="single_blog_item">
                                <div class="blog_img">
                                    <img src="{{asset('assets/user-fontend/img/climate_effect.jpg')}}" alt="">
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="blog_news">
                            <div class="single_blog_item">
                                <div class="blog_img">
                                    <img src="{{asset('assets/user-fontend/img/air_pollutuon.jpg')}}" alt="">
                                </div>
                                <div class="blog_content">
                    ...
                    <div class="col-md-4">
                        <div class="blog_news">
                            <div class="single_blog_item">
                                <div class="blog_img">
                                        <img src="{{asset('assets/user-fontend/img/threat_bear.jpg')}}" alt="">
                                </div>
                                <div class="blog_content">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="market_logo">
                                        <a href=""><img src="{{asset('assets/user-fontend/img/audiojungle.png')}}" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="market_logo">
                                        <a href=""><img src="{{asset('assets/user-fontend/img/codecanyon.png')}}" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="market_logo">
                                        <a href=""><img src="{{asset('assets/user-fontend/img/graphicriver.png')}}" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="market_logo">
