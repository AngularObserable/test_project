        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a href="{{ route('admin.tag.create') }}" class="btn btn-sm btn-success pull-left">Create</a>
                    ...
                    <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="true" data-add-display-all-btn="true" data-add-focus-btn="true">
                        <table cellspacing="0" class="table"  id="search-datatable">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <button class="btn btn-icon btn-red" onclick="deleteTag({{ $tag->id }})">
                                        <i class="fa-remove"></i>
                                    </button>
                                    ...
                                    <a href="{{route('admin.tag.edit',$tag->id)}}" class="btn btn-icon btn-success">
                                        <i class="fa-edit"></i>
                                    </a>
