...
@include('author.partials.topbar')
...
@include('author.partials.footer-stick')
...
<script src="{{ asset('dashboard/js/uikit/js/addons/htmleditor.min.js')}}"></script>
<script src="{{ asset('dashboard/js/wysihtml5/src/bootstrap-wysihtml5.js') }}"></script>
<script src="{{ asset('dashboard/js/wysihtml5/lib/js/wysihtml5-0.3.0.js') }}"></script>
<link rel="stylesheet" href="{{ asset('dashboard/js/wysihtml5/src/bootstrap-wysihtml5.css')}}">
{{-- Custom Javascript --}}
