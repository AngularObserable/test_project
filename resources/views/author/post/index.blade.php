        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a href="{{ route('author.post.create') }}" class="btn btn-sm btn-success pull-right">Create</a>
                    <h6>
                        ALL POSTS
                    ...
                    <div class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="true" data-add-display-all-btn="true" data-add-focus-btn="true">
                        <table cellspacing="0" class="table"  id="search-datatable">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="{{ route('author.post.edit',$post->id) }}" class="btn btn-icon btn-success">
                                        <i class="fa-edit"></i>
                                    </a>
                                    <a href="{{route('author.post.show',$post->id)}}" class="btn btn-icon btn-primary">
                                        <i class="fa-eye"></i>
                                    </a>
